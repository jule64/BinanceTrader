...
async function buildCoinCostMap(tickersList, bookCostmap, ftxRestCli) {
...
function calculateCoinCost(coin, balances, orderHistory) {
...
module.exports = {buildCoinCostMap, reBuildBookCostForTicker, coinBookCostTest}